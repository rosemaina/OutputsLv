...
extension ViewController {
  ...
  func upload(image: UIImage,
    ...
    Alamofire.upload(
      ...
      headers: ["Authorization": "Basic YWNjX2E3Y2FiNmM2N2I5NmIxYzowNzNkZmE5YzRmZTM5NDZiMjhmYmQ0MWJlYWYxNDk0MA=="],
      encodingCompletion: { encodingResult in
        ...
        case .success(let upload, _, _):
          ...
          upload.responseJSON { response in
            ...
            // Check if the response was successful; if not, print the error and call the completion handler
            ...
            /*
             Check each portion of the response, verifying the expected type is the actual type received.
             Retrieve the firstFileID from the response. If firstFileID cannot be resolved
    ...
    Alamofire.request(
      ...
      .responseJSON { response in
        ...
        guard
          ...
          let imageColors = info["image_colors"] as? [[String: Any]]
          else {
